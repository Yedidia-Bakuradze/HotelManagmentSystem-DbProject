...
BEGIN
    WHILE v_shift_count < p_num_shifts LOOP
        ...
        IF v_shift_count < p_num_shifts THEN
            ...
            EXCEPTION
                WHEN OTHERS THEN
                    DBMS_OUTPUT.PUT_LINE('Error creating/assigning morning shift on ' || v_shift_date || ': ' || SQLERRM);
            END;
        END IF;
        ...
        IF v_shift_count < p_num_shifts THEN
            ...
            EXCEPTION
                WHEN OTHERS THEN
                    DBMS_OUTPUT.PUT_LINE('Error creating/assigning evening shift on ' || v_shift_date || ': ' || SQLERRM);
            END;
        END IF;
